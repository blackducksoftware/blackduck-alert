    ...
    void policySearchStringTest() {
        ...
        String expectedSearchString =
            "("
                ...
                + " AND (comment ~ \"projectId: project-uuid\" OR comment ~ \"projectId: project_with_single_quote\\'\" )"
                + " AND (comment ~ \"projectVersionId: project-version-uuid\" OR comment ~ \"projectVersionId: v1.0 \\\\& v2.0\" )"
    ...
    void injectionTest() {
        ...
        String expectedSearchString =
            "("
                ...
                + " AND comment ~\"=== BEGIN JIRA ISSUE KEYS ===\""
                + " AND (comment ~ \"projectId: project-uuid\" OR comment ~ \"projectId: project_with_single_quote\\'\" )"
                + " AND (comment ~ \"projectVersionId: projectVersionUrl\" OR comment ~ \"projectVersionId: INJECTED\\\\\\' OR project = \"SomeOtherProject\" OR summary ~ 2021-01-01\\\\\\\\\\\\\" )"
                + " AND comment ~ \"componentName: myVulnerableComponent\""
                + " AND comment ~ \"componentVersionName: 1.1.2\""
                + " AND comment ~ \"category: VULNERABILITY\""
                + " ) OR ("
