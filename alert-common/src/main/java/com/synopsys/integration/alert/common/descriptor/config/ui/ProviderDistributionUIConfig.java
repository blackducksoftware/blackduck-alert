...
public abstract class ProviderDistributionUIConfig extends UIConfig {
    ...
    protected static final String DESCRIPTION_FILTER_BY_PROJECT = "If false, all projects will be included. Any notifications matching the configured notification types will be processed.";
