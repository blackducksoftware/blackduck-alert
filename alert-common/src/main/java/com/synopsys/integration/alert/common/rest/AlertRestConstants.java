 ...
 *
 * Use subject to the terms and conditions of the Synopsys End User Software License and Maintenance Agreement. All
...
public final class AlertRestConstants {
    ...
    public static final String DEFAULT_CLIENT_CERTIFICATE_KEY_NAME = "default-alert-client-certificate-key";
