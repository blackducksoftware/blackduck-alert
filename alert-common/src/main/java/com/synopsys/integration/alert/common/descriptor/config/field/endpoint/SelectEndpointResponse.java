...
public abstract class SelectEndpointResponse extends EndpointResponse<List<LabelValueSelectOption>> {
    ...
    protected SelectEndpointResponse(final String fieldKey, final CustomEndpointManager customEndpointManager, final ResponseFactory responseFactory, final Gson gson) throws AlertException {
