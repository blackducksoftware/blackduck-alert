...
public abstract class Descriptor extends AlertSerializableModel {
    ...
    private DescriptorMetadata createMetaData(final UIConfig uiConfig, final ConfigContextEnum context) {
        ...
        final String componentName = uiConfig.getComponentPath();
        return new DescriptorMetadata(label, urlName, getName(), description, getType(), context, fontAwesomeIcon, autoGenerateUI, componentName, uiConfig.createFields(), uiConfig.createTestLabel());
    }
