...
public abstract class Descriptor extends Stringable {
    ...
    private DescriptorMetadata createMetaData(UIConfig uiConfig, ConfigContextEnum context) {
        ...
        return new DescriptorMetadata(descriptorKey, label, urlName, description, getType(), context, autoGenerateUI, componentNamespace, uiConfig.createFields(), uiConfig.createTestLabel(), uiConfig.createTestFields());
    }
