        ...
        if (filePersistenceUtil.exists(LAST_SEARCH_FILE)) {
            ...
            try {
                ...
                if (configurationModels.size() == 1) {
                    ...
                    String taskName = String.format("Task::Class[com.blackduck.integration.alert.provider.blackduck.tasks.BlackDuckAccumulator]::Provider[provider_blackduck]::Configuration[id:%s]", configId);
