...
public class CommonGlobalConfigHandler<D extends DatabaseEntity, R extends ConfigRestModel, W extends AbstractRepositoryWrapper<D, Long, ?>> extends CommonConfigHandler<D, R, W> {
    ...
    public ResponseEntity<String> postConfig(final R restModel) {
        if (!configActions.repositoryWrapper.findAll().isEmpty()) {
