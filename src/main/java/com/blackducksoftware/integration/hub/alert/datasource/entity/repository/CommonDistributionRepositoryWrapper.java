...
public class CommonDistributionRepositoryWrapper extends SimpleKeyRepositoryWrapper<CommonDistributionConfigEntity, CommonDistributionRepository> {
    ...
    public CommonDistributionConfigEntity findByDistributionConfigIdAndDistributionType(final Long distributionConfigId, final String distributionType) {
        final CommonDistributionConfigEntity entity = getRepository().findByDistributionConfigIdAndDistributionType(distributionConfigId, distributionType);
        try {
    ...
    public List<CommonDistributionConfigEntity> findByDistributionType(final String distributionType) {
        final List<CommonDistributionConfigEntity> entity = getRepository().findByDistributionType(distributionType);
        return decryptSensitiveData(entity);
    }
}
