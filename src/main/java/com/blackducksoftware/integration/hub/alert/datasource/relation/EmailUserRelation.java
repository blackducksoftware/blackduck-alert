...
@Entity
@Table(name = "email_user", schema = "user")
public class EmailUserRelation extends DatabaseRelation {
    ...
    public EmailUserRelation(final Long userConfidId, final Long emailConfigId) {
        super(userConfidId);
