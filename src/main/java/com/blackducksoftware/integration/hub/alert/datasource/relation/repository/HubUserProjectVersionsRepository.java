...
@Transactional
public interface HubUserProjectVersionsRepository extends JpaRepository<HubUserProjectVersionsRelation, HubUserProjectVersionsRelationPK> {
    public List<HubUserProjectVersionsRelation> findByUserConfigId(final Long userConfigId);
}
