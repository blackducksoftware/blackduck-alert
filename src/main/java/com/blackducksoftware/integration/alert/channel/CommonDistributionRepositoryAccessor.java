...
@Component
public class CommonDistributionRepositoryAccessor extends RepositoryAccessor {
    private final CommonDistributionRepository repository;

    @Autowired
    public CommonDistributionRepositoryAccessor(final CommonDistributionRepository repository) {
        super(repository);
    ...
    public DatabaseEntity saveEntity(final DatabaseEntity entity) {
        ...
        return repository.save(commonEntity);
    }
