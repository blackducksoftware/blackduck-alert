...
public class CollectorLookup {
    private Map<FormatType, TopicCollector> formatCollectorMap;

    public CollectorLookup(final List<TopicCollector> topicCollectorList) {
        // FIXME formatCollectorMap = topicCollectorList.stream().collect(Collectors.toMap(TopicCollector::getFormat, Function.identity()));
    }
