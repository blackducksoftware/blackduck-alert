...
public class PasswordConfigField extends ConfigField {
    ...
    public static PasswordConfigField create(final String key, final String label, final Function<FieldValueModel, Collection<String>> validationFunction) {
    ...
    public static PasswordConfigField createRequired(final String key, final String label, final Function<FieldValueModel, Collection<String>> validationFunction) {
    ...
    public PasswordConfigField(final String key, final String label, final boolean required, final Function<FieldValueModel, Collection<String>> validationFunction) {
