...
public class PolarisGlobalDescriptorActionApi extends DescriptorActionApi {
    ...
    public void validateConfig(final FieldAccessor fieldAccessor, final Map<String, String> fieldErrors) {
        final String accessToken = fieldAccessor.getString(PolarisDescriptor.KEY_POLARIS_ACCESS_TOKEN).orElse(null);
        ...
        final String polarisTimeout = fieldAccessor.getString(PolarisDescriptor.KEY_POLARIS_TIMEOUT).orElse(null);
    ...
    public void testConfig(final TestConfigModel testConfig) throws IntegrationException {
        ...
        validateFieldFormatting(fieldAccessor);
