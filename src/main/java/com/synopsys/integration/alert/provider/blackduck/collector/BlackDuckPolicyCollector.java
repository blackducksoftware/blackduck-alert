...
public abstract class BlackDuckPolicyCollector extends BlackDuckCollector {
    ...
    protected void addApplicableItems(final Set<CategoryItem> categoryItems, final Long notificationId, final Set<LinkableItem> policyItems, final ItemOperation operation, final Set<LinkableItem> applicableItems,
