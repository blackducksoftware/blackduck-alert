...
public class BlackDuckLicenseLimitCollector extends MessageContentCollector {
    ...
    public BlackDuckLicenseLimitCollector(final JsonExtractor jsonExtractor, final BlackDuckProperties blackDuckProperties) {
        super(jsonExtractor, Arrays.asList(BlackDuckContent.LICENSE_LIMIT));
        this.blackDuckProperties = blackDuckProperties;
    }

    @Override
    protected void addCategoryItems(final Set<CategoryItem> categoryItems, final JsonFieldAccessor jsonFieldAccessor, final List<JsonField<?>> notificationFields, final AlertNotificationWrapper notificationContent) {
