...
public class BlackDuckDescriptor extends ProviderDescriptor {
    ...
    public static final String KEY_BLACKDUCK_POLICY_NOTIFICATION_TYPE_FILTER_ENABLED = "blackduck.policy.notification.filter.enabled";
    ...
    public static final String KEY_BLACKDUCK_VULNERABILITY_NOTIFICATION_TYPE_FILTER_ENABLED = "blackduck.vulnerability.notification.filter.enabled";
