...
public class BlackDuckDistributionUIConfig extends ProviderDistributionUIConfig {
    ...
    public List<ConfigField> createProviderDistributionFields() {
        final ConfigField filterByProject = CheckboxConfigField.createRequired(CommonDistributionConfiguration.KEY_FILTER_BY_PROJECT, "Filter by project", BLACKDUCK_FILTER_BY_PROJECT_DESCRIPTION);
        final ConfigField projectNamePattern = TextInputConfigField.create(CommonDistributionConfiguration.KEY_PROJECT_NAME_PATTERN, "Project name pattern", BLACKDUCK_PROJECT_NAME_PATTERN_DESCRIPTION, this::validateProjectNamePattern);
