...
public class AuditUIConfig extends CustomUIConfig {
    ...
    public AuditUIConfig() {
        super(AuditDescriptor.AUDIT_LABEL, AuditDescriptor.AUDIT_DESCRIPTION, AuditDescriptor.AUDIT_URL, AuditDescriptor.AUDIT_ICON, AuditDescriptor.AUDIT_COMPONENT_PATH);
    }
