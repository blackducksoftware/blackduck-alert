...
@Component
public class SchedulingStartupComponent extends StartupComponent {
    private final EntityPropertyMapper entityPropertyMapper;

    @Autowired
    public SchedulingStartupComponent(final EntityPropertyMapper entityPropertyMapper) {
        super(new SchedulingConfig());
