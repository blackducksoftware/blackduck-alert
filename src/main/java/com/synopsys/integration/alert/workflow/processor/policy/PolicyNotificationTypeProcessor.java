 ...
 * under the License.
 */
package com.synopsys.integration.alert.workflow.processor.policy;
...
public class PolicyNotificationTypeProcessor extends NotificationTypeProcessor {
    ...
    @Override
    public List<NotificationModel> process(final BlackDuckProperties blackDuckProperties, final NotificationDetailResult notificationDetailResult, final HubBucket bucket) {
