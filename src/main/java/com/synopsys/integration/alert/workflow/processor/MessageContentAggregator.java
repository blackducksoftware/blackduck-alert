...
public class MessageContentAggregator {
    ...
    public Map<CommonConfigurationModel, List<AggregateMessageContent>> processNotifications(final FrequencyType frequency, final Collection<NotificationContent> notificationList) {
    ...
    public Map<CommonConfigurationModel, List<AggregateMessageContent>> processNotifications(final List<CommonConfigurationModel> distributionConfigs, final Collection<NotificationContent> notificationList) {
        if (notificationList.isEmpty()) {
            return Collections.emptyMap();
        }
    ...
    private List<AggregateMessageContent> collectTopics(final CommonConfigurationModel jobConfiguration, final Collection<NotificationContent> notificationCollection) {
    ...
    private Collection<NotificationContent> filterNotifications(final ProviderDescriptor providerDescriptor, final CommonConfigurationModel jobConfiguration, final Collection<NotificationContent> notificationCollection) {
