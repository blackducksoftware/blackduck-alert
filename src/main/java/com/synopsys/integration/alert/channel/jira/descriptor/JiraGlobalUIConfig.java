...
public class JiraGlobalUIConfig extends UIConfig {
    ...
    public static final String ENDPOINT_PLUGIN_CONFIGURATION = "blank";
    ...
    public List<ConfigField> createFields() {
        ...
        final ConfigField jiraConfigurePlugin = EndpointField.createRequiredWithSuccessBox(JiraDescriptor.KEY_JIRA_CONFIGURE_PLUGIN, LABEL_CONFIGURE_PLUGIN, DESCRIPTION_CONFIGURE_PLUGIN, ENDPOINT_PLUGIN_CONFIGURATION)
