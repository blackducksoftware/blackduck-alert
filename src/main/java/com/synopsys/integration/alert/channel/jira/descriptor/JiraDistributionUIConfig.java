...
public class JiraDistributionUIConfig extends ChannelDistributionUIConfig {
    ...
    public static final String DESCRIPTION_RESOLVE_WORKFLOW_TRANSITION = "If a transition is listed, it will be used when resolving an issue.";
    public static final String DESCRIPTION_OPEN_WORKFLOW_TRANSITION = "If a transition is listed, it will be used when re-opening an issue.";
