...
public class EmailGlobalUIConfig extends UIConfig {
    public static final String KEY_HOST = "channel.email.smtp.host";
    public static final String KEY_FROM = "channel.email.smtp.from";
    public static final String KEY_AUTH = "channel.email.smtp.auth";
    public static final String KEY_USER = "channel.email.smtp.user";
    public static final String KEY_PASSWORD = "channel.email.smtp.password";
    public static final String KEY_PORT = "channel.email.smtp.port";
    public static final String KEY_CONNECTION_TIMEOUT = "channel.email.smtp.connection.timeout";
    public static final String KEY_TIMEOUT = "channel.email.smtp.timeout";
    public static final String KEY_WRITE_TIMEOUT = "channel.email.smtp.write.timeout";
    public static final String KEY_LOCALHOST = "channel.email.smtp.localhost";
    public static final String KEY_LOCAL_ADDRESS = "channel.email.smtp.local.address";
    public static final String KEY_LOCAL_PORT = "channel.email.smtp.local.port";
    public static final String KEY_EHLO = "channel.email.smtp.ehlo";
    public static final String KEY_AUTH_MECHANISMS = "channel.email.smtp.auth.mechanisms";
    public static final String KEY_AUTH_LOGIN_DISABLE = "channel.email.smtp.auth.login.disable";
    public static final String KEY_AUTH_PLAIN_DISABLE = "channel.email.smtp.auth.plain.disable";
    public static final String KEY_AUTH_DIGEST_MD5_DISABLE = "channel.email.smtp.auth.digest.md5.disable";
    public static final String KEY_AUTH_NTLM_DISABLE = "channel.email.smtp.auth.ntlm.disable";
    public static final String KEY_AUTH_NTLM_DOMAIN = "channel.email.smtp.auth.ntlm.domain";
    public static final String KEY_AUTH_NTLM_FLAGS = "channel.email.smtp.ntlm.flags";
    public static final String KEY_AUTH_XOAUTH2_DISABLE = "channel.email.smtp.xoauth2.disable";
    public static final String KEY_SUBMITTER = "channel.email.smtp.submitter";
    public static final String KEY_DNS_NOTIFY = "channel.email.smtp.dns.notify";
    public static final String KEY_DNS_RET = "channel.email.smtp.dns.ret";
    public static final String KEY_ALLOW_8BIT_MIME = "channel.email.smtp.allow.8bit.mime";
    public static final String KEY_SEND_PARTIAL = "channel.email.smtp.send.partial";
    public static final String KEY_SASL_ENABLE = "channel.email.smtp.sasl.enable";
    public static final String KEY_SASL_MECHANISMS = "channel.email.smtp.sasl.mechanisms";
    public static final String KEY_SASL_AUTHORIZATION_ID = "channel.email.smtp.sasl.authorication.id";
    public static final String KEY_SASL_REALM = "channel.email.smtp.sasl.realm";
    public static final String KEY_SASL_USE_CANONICAL_HOSTNAME = "channel.email.smtp.sasl.use.canonical.hostname";
    public static final String KEY_QUIT_WAIT = "channel.email.smtp.quit.wait";
    public static final String KEY_REPORT_SUCCESS = "channel.email.smtp.report.success";
    public static final String KEY_SSL_ENABLE = "channel.email.smtp.ssl.enable";
    public static final String KEY_SSL_CHECK_SERVER_IDENTITY = "channel.email.smtp.ssl.check.server.identity";
    public static final String KEY_SSL_TRUST = "channel.email.smtp.ssl.trust";
    public static final String KEY_SSL_PROTOCOLS = "channel.email.smtp.ssl.protocols";
    public static final String KEY_SSL_CIPHER_SUITES = "channel.email.smtp.ssl.cipher.suites";
    public static final String KEY_START_TLS_ENABLE = "channel.email.smtp.start.tls.enable";
    public static final String KEY_START_TLS_REQUIRED = "channel.email.smtp.start.tls.required";
    public static final String KEY_PROXY_HOST = "channel.email.smtp.proxy.host";
    public static final String KEY_PROXY_PORT = "channel.email.smtp.proxy.port";
    public static final String KEY_SOCKS_HOST = "channel.email.smtp.socks.host";
    public static final String KEY_SOCKS_PORT = "channel.email.smtp.socks.port";
    public static final String KEY_MAIL_EXTENSION = "channel.email.smtp.mail.extension";
    public static final String KEY_USER_SET = "channel.email.smtp.user.set";
    public static final String KEY_NOOP_STRICT = "channel.email.smtp.noop.strict";
