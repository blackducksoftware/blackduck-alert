...
public class SlackEventProducer extends ChannelEventProducer {
    ...
    public SlackChannelEvent createChannelEvent(final CommonDistributionConfig commonDistributionConfig, final AggregateMessageContent messageContent) {
        final SlackDistributionConfig slackDistributionConfig = (SlackDistributionConfig) commonDistributionConfig;
    ...
    @Override
    public SlackChannelEvent createChannelTestEvent(final CommonDistributionConfig commonDistributionConfig) {
