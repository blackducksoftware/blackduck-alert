...
public class EmailDistributionUIConfig extends ChannelDistributionUIConfig {
    ...
    @Autowired
    public EmailDistributionUIConfig(EmailChannelKey emailChannelKey, ConfigurationAccessor configurationAccessor) {
        super(emailChannelKey, EmailDescriptor.EMAIL_LABEL, EmailDescriptor.EMAIL_URL, configurationAccessor, true);
    }
