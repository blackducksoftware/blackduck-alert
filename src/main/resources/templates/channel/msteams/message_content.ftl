...
<#list sections as section>
    {
      ...
      "text": "<#list section.components as component>* ${component.category?json_string} (${component.operation?json_string}): ${component.text}  ${'\r\n'}${component.allAttributeDetails?json_string}<#sep>${'\r\n'}</#sep></#list>"
    }<#sep>, </#sep>
</#list>
  ]
}
