...
class Index extends Component {
    ...
    typeColumnDataFormat(cell, row) {
        ...
        const data = (<div title={cellText}>
            <i key="icon" className={fontAwesomeClass} aria-hidden="true" />
            {cellText}
        </div>);
    ...
    createCustomButtonGroup(buttons) {
        ...
        if (!this.state.autoRefresh) {
            refreshButton = (<div className={classes} onClick={reloadEntries} >
                <i className={fontAwesomeIcon} aria-hidden="true" />Refresh
            </div>);
        }
	    return (
            <div>
    ...
    render() {
        ...
        let content = (<div>
            <BootstrapTable hover condensed data={this.state.jobs} containerClass="table" insertRow deleteRow selectRow={jobsSelectRowProp} search options={jobTableOptions} trClassName="tableRow" headerContainerClass="scrollable" bodyContainerClass="tableScrollableBody">
