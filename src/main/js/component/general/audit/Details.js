...
class Details extends Component {
    ...
    render(content) {
        ...
        const defaultContent = Object.assign({}, {'warning': 'Content in an Unknown Format'});
        const jsonContent = this.state.values.content || JSON.stringify(defaultContent);
        const jsonPrettyPrintContent = JSON.stringify(JSON.parse(jsonContent), null, 2);
        return (
