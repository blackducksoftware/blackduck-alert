    ...
    setEntriesFromArray(jsonArray = []) {
        const entries = jsonArray.map((entry) => {
            ...
            if (notification) {
                ...
                result.projectName = notification.projectName;
                result.projectVersion = notification.projectVersion;
            ...
            <div>
                ...
                <div>
                    ...
                    >
                        ...
                        <TableHeaderColumn dataField="projectName" dataSort columnTitle columnClassName="tableCell">Project Name</TableHeaderColumn>
