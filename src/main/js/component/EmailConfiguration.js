	...
	render() {
		return (
				<div>
					...
					<TextInput label="Email Template Directory" name="emailTemplateDirectory" value={this.state.emailTemplateDirectory} onChange={this.handleChange} errorName="emailTemplateDirectoryError" errorValue={this.state.errors.emailTemplateDirectoryError}></TextInput>
					<TextInput label="Email Template Logo" name="emailTemplateLogoImage" value={this.state.emailTemplateLogoImage} onChange={this.handleChange} errorName="emailTemplateLogoImageError" errorValue={this.state.errors.emailTemplateLogoImageError}></TextInput>
					<TextInput label="Email Subject Line" name="emailSubjectLine" value={this.state.emailSubjectLine} onChange={this.handleChange} errorName="emailSubjectLineError" errorValue={this.state.errors.emailSubjectLineError}></TextInput>
