            ...
            <div>
                ...
                <form className="form-horizontal" onSubmit={this.handleSubmit}>
                    <div>
                        ...
                        <TextInput id="hubConfigurationApiToken" label="API Token" name="hubApiKey" value={this.state.hubApiKey} isSet={this.state.hubApiKeyIsSet} onChange={this.handleChange} errorMessage={this.props.fieldErrors.apiKey || this.props.fieldErrors.hubApiKey} />
                        <NumberInput id="hubConfigurationTimeout" label="Timeout" name="hubTimeout" value={this.state.hubTimeout} onChange={this.handleChange} />
