	...
	render() {
		let content =
				<div>
					...
					<TextInput label="API Key" name="hubApiKey" value={this.state.values.hubApiKey} isSet={this.state.values.hubApiKeyIsSet} onChange={this.handleChange} errorName="apiKeyError" errorValue={this.state.errors.apiKeyError}></TextInput>
