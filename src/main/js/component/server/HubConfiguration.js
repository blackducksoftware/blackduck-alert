	...
	render() {
		let content =
				<div>
					...
					<TextInput label="API Key" name="hubApiKey" value={this.state.values.hubApiKey} onChange={this.handleChange} errorName="apiKeyError" errorValue={this.state.errors.apiKeyError}></TextInput>
