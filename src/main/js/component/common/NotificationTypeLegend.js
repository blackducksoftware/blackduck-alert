...
const policyViolationIcon = <span key="policyViolationIcon" alt="Policy Violation" title="Policy Violation" className="fa fa-ban policyViolation" aria-hidden="true" />;
const policyViolationClearedIcon = <span key="policyViolationClearedIcon" alt="Policy Violation Cleared" title="Policy Violation Cleared" className="fa fa-eraser policyViolationCleared" aria-hidden="true" />;
const policyViolationOverrideIcon = <span key="policyViolationOverrideIcon" alt="Policy Override" title="Policy Override" className="fa fa-exclamation-circle policyViolationOverride" aria-hidden="true" />;
const highVulnerabilityIcon = <span key="highVulnerabilityIcon" alt="High Vulnerability" title="High Vulnerability" className="fa fa-shield highVulnerability" aria-hidden="true" />;
const mediumVulnerabilityIcon = <span key="mediumVulnerabilityIcon" alt="Medium Vulnerability" title="Medium Vulnerability" className="fa fa-shield mediumVulnerability" aria-hidden="true" />;
const lowVulnerabilityIcon = <span key="lowVulnerabilityIcon" alt="Low Vulnerability" title="Low Vulnerability" className="fa fa-shield lowVulnerability" aria-hidden="true" />;
const vulnerabilityIcon = <span key="vulnerabilityIcon" alt="Vulnerability" title="Vulnerability" className="fa fa-shield vulnerability" aria-hidden="true" />;
