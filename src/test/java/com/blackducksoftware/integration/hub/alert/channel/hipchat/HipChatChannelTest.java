...
public class HipChatChannelTest extends ChannelTest {
    ...
    public void sendMessageTestIT() throws IOException, IntegrationException {
        ...
        HipChatChannel hipChatChannel = new HipChatChannel(auditEntryRepository, null, null, null, channelRestConnectionFactory);
    ...
    public void createRequestThrowsExceptionWhenRoomIdIsNullTest() {
        final HipChatChannel hipChatChannel = new HipChatChannel(null, null, null, null, null);
    ...
    public void createRequestThrowsExceptionTest() throws Exception {
        final AuditEntryRepositoryWrapper auditEntryRepository = Mockito.mock(AuditEntryRepositoryWrapper.class);
        final HipChatChannel hipChatChannel = new HipChatChannel(auditEntryRepository, null, null, null, null);
    ...
    public void testGlobalConfigNullTest() throws Exception {
        ...
        final HipChatChannel hipChatChannel = new HipChatChannel(null, null, null, null, restFactory);
