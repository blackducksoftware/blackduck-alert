...
public class HubUsersConfigWrapperTest {
    ...
    public void emptyModelTest() {
        ...
        final String expectedString = "{\"username\":null,\"frequency\":null,\"emailConfigId\":null,\"hipChatConfigId\":null,\"slackConfigId\":null,\"active\":null,\"projectVersions\":null,\"id\":null}";
    ...
    public void modelTest() {
        ...
        final String expectedString = "{\"username\":\"" + username + "\",\"frequency\":\"" + frequency + "\",\"emailConfigId\":\"" + emailConfigId + "\",\"hipChatConfigId\":\"" + hipChatConfigId + "\",\"slackConfigId\":\"" + slackConfigId
                + "\",\"active\":\"" + active + "\",\"projectVersions\":" + projectVersions + ",\"id\":\"" + id + "\"}";
        assertEquals(expectedString, configWrapper.toString());

        final HubUsersConfigWrapper newModel = new HubUsersConfigWrapper(id, username, frequency, emailConfigId, hipChatConfigId, slackConfigId, active, projectVersions);
        assertEquals(configWrapper, newModel);
    }
}
