...
public class MockNotificationEntity extends MockEntityUtil<NotificationEntity> {
    ...
    public MockNotificationEntity() {
        this("_event_key_", new Date(400), NotificationCategoryEnum.POLICY_VIOLATION, "projectName", "projectVersion", "componentName", "componentVersion", "policyRuleName", "person", "projectUrl", "projectVersionUrl",
    ...
    private MockNotificationEntity(final String eventKey, final Date createdAt, final NotificationCategoryEnum notificationType, final String projectName, final String projectVersion, final String componentName,
            final String componentVersion, final String policyRuleName, final String person, final String projectUrl, final String projectVersionUrl, final Collection<VulnerabilityEntity> vulnerabilityList, final Long id) {
        super();
