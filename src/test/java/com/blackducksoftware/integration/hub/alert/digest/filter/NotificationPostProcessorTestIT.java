...
public class NotificationPostProcessorTestIT {
    ...
    public void getApplicableConfigurationsTest() {
        ...
        final CommonDistributionConfigEntity config1 = new CommonDistributionConfigEntity(config1Id, SupportedChannels.EMAIL_GROUP, "Config 1", configuredDigestType, true);
        config1.setId(config1Id);

        final Long config2Id = 17L;
        final CommonDistributionConfigEntity config2 = new CommonDistributionConfigEntity(config2Id, SupportedChannels.EMAIL_GROUP, "Config 2", configuredDigestType, false);
    ...
    public void filterMatchingNotificationsTest() {
        ...
        final NotificationModel notificationModel = createNotificationModel();
        final Long config1Id = 13L;
        final CommonDistributionConfigEntity config1 = new CommonDistributionConfigEntity(config1Id, SupportedChannels.EMAIL_GROUP, "Config 1", DigestTypeEnum.REAL_TIME, true);
        config1.setId(config1Id);
