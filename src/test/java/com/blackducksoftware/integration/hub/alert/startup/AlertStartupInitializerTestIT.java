...
import com.blackducksoftware.integration.hub.alert.channel.email.EmailGroupDescriptor;
...
public class AlertStartupInitializerTestIT {
    ...
    public void testInitializeConfigs() throws Exception {
        ...
        final List<Descriptor> descriptors = Arrays.asList(new EmailGroupDescriptor(null, globalEmailRepository, null, null, objectTransformer));
