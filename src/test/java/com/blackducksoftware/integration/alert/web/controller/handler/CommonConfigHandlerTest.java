...
public class CommonConfigHandlerTest {
    ...
    public void getConfigTest() throws AlertException {
        ...
        final CommonConfigHandler<GlobalHubConfigEntity, GlobalHubConfigRestModel, GlobalHubRepository> handler = new CommonConfigHandler<>(GlobalHubConfigEntity.class,
                GlobalHubConfigRestModel.class, configActions, contentConverter);

        final List<GlobalHubConfigRestModel> restModel = Arrays.asList(mockGlobalHubRestModel.createEmptyGlobalRestModel());
        Mockito.doReturn(restModel).when(configActions).getConfig(Mockito.anyLong());

        final List<GlobalHubConfigRestModel> list = handler.getConfig(1L);
    ...
    public void getConfigHandleExceptionTest() throws AlertException {
        ...
        List<GlobalHubConfigRestModel> list = null;
        try {
