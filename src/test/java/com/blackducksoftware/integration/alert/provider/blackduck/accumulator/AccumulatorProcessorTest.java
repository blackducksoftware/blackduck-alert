...
public class AccumulatorProcessorTest {
    ...
    public void testProcess() throws Exception {
        ...
        final BlackDuckAccumulatorProcessor blackDuckAccumulatorProcessor = new BlackDuckAccumulatorProcessor(hubProperties, processorList, contentConverter);

        final AlertEvent storeEvent = blackDuckAccumulatorProcessor.process(notificationData);
    ...
    public void testProcessorListNull() throws Exception {
        ...
        final NotificationDetailResults notificationData = new NotificationDetailResults(resultList, vulnerabilityResults.getLatestNotificationCreatedAtDate(), vulnerabilityResults.getLatestNotificationCreatedAtString(),
                vulnerabilityResults.getHubBucket());
        final BlackDuckAccumulatorProcessor blackDuckAccumulatorProcessor = new BlackDuckAccumulatorProcessor(hubProperties, null, contentConverter);

        final AlertEvent storeEventNull = blackDuckAccumulatorProcessor.process(notificationData);
    ...
    public void testProcessNullList() throws Exception {
        final BlackDuckProperties hubProperties = Mockito.mock(BlackDuckProperties.class);
        final BlackDuckAccumulatorProcessor blackDuckAccumulatorProcessor = new BlackDuckAccumulatorProcessor(hubProperties, null, contentConverter);
        final AlertEvent nullStoreEvent = blackDuckAccumulatorProcessor.process(null);
