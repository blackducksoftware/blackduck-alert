...
public class EmailDistributionTypeConverterTestIT {
    ...
    public void populateConfigFromEntityTest() {
        ...
        final CommonDistributionConfigEntity commonDistributionConfigEntity = new CommonDistributionConfigEntity(savedEmailEntity.getId(), EmailGroupChannel.COMPONENT_NAME, "nice name", "some_provider", DigestType.REAL_TIME, Boolean.FALSE);
