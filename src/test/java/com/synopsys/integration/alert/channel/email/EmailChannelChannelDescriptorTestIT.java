...
import com.synopsys.integration.alert.common.persistence.model.*;
...
public class EmailChannelChannelDescriptorTestIT extends ChannelDescriptorTest {
    ...
    public void testSetup() throws Exception {
        ...
        ProviderProject project1 = providerDataAccessor.saveProject(BLACK_DUCK_PROVIDER_KEY.getUniversalKey(), new ProviderProject(UNIT_TEST_PROJECT_NAME, "", "", ""));
        ProviderProject project2 = providerDataAccessor.saveProject(BLACK_DUCK_PROVIDER_KEY.getUniversalKey(), new ProviderProject("TestProject2", "", "", ""));
        ProviderProject project3 = providerDataAccessor.saveProject(BLACK_DUCK_PROVIDER_KEY.getUniversalKey(), new ProviderProject("Project three", "", "", ""));
        ProviderProject project4 = providerDataAccessor.saveProject(BLACK_DUCK_PROVIDER_KEY.getUniversalKey(), new ProviderProject("Project four", "", "", ""));
        ProviderProject project5 = providerDataAccessor.saveProject(BLACK_DUCK_PROVIDER_KEY.getUniversalKey(), new ProviderProject("Project UnitTest five", "", "", "noreply@blackducksoftware.com"));
    ...
    public DistributionEvent createChannelEvent() throws AlertException {
        ...
        String createdAt = RestConstants.formatDate(DateRange.createCurrentDateTimestamp());
    ...
    public void testProjectOwner() throws Exception {
        ...
        List<ConfigurationModel> model = configurationAccessor.getConfigurationByDescriptorNameAndContext(getDescriptor().getDescriptorKey().getUniversalKey(), ConfigContextEnum.DISTRIBUTION);
