...
public class HipChatChannelDescriptorTestIT extends ChannelDescriptorTest {
    ...
    public DistributionEvent createChannelEvent() {
        ...
        final DistributionEvent event = new DistributionEvent(
            String.valueOf(distribution_config.getConfigurationId()), HipChatChannel.COMPONENT_NAME, createdAt, BlackDuckProvider.COMPONENT_NAME, FormatType.DEFAULT.name(), MessageContentGroup.singleton(content), fieldAccessor);
        return event;
    }
