...
public class AlertSetupTest {
    ...
    @Test
    @Ignore
    public void testConfigureRunningAlert() throws Exception {
        loginToAlert();
        setupBlackDuck();
    }
    ...
    private void loginToAlert() throws Exception {
        ...
        client.addCommonRequestHeader("Set-Cookie", cookie);
    ...
    private void setupBlackDuck() throws Exception {
        ...
        FieldModel blackDuckProviderConfiguration = new FieldModel(BLACKDUCK_PROVIDER_KEY, ConfigContextEnum.GLOBAL.name(), keyToValues);
        ...
        validateBlackDuckConfiguration(requestBody);
        createBlackDuckConfiguration(requestBody);
    }

    private void validateBlackDuckConfiguration(BodyContent requestBody) throws Exception {
        ...
        validationRequestBuilder.bodyContent(requestBody);
    ...
    private void createBlackDuckConfiguration(BodyContent requestBody) throws Exception {
        ...
        creationRequestBuilder.bodyContent(requestBody);
