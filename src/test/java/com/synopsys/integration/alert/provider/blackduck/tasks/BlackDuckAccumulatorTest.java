...
public class BlackDuckAccumulatorTest {
    ...
    @Test
    public void testRun() {
        final BlackDuckAccumulator notificationAccumulator = new BlackDuckAccumulator(taskScheduler, testBlackDuckProperties, notificationManager, filePersistenceUtil, BLACK_DUCK_PROVIDER_KEY);
        final BlackDuckAccumulator spiedAccumulator = Mockito.spy(notificationAccumulator);
    ...
    public void testAccumulateWithDateRange() throws Exception {
        ...
        final BlackDuckAccumulator notificationAccumulator = new BlackDuckAccumulator(taskScheduler, mockedBlackDuckProperties, notificationManager, filePersistenceUtil, BLACK_DUCK_PROVIDER_KEY);
        final BlackDuckAccumulator spiedAccumulator = Mockito.spy(notificationAccumulator);
