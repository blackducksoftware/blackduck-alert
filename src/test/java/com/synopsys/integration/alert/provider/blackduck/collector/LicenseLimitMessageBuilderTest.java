...
public class LicenseLimitMessageBuilderTest {
    ...
    public void buildMessageContentTest() {
        ...
        List<ProviderMessageContent> providerMessageContents = licenseLimitMessageBuilder.buildMessageContents(commonMessageData, licenseLimitNotificationView, blackDuckServicesFactory);
