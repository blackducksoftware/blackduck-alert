...
public class BlackDuckDescriptorConfigTest {
    ...
    public void testRepositoryCalls() {
        ...
        final BlackDuckProviderDescriptorActionApi hubDescriptorConfig = new BlackDuckProviderDescriptorActionApi(null, hubRepositoryAccessor, null, null);
    ...
    public void testValidateGlobalConfig() {
        final BlackDuckProviderDescriptorActionApi hubDescriptor = new BlackDuckProviderDescriptorActionApi(null, null, null, null);
        final BlackDuckProviderDescriptorActionApi spiedDescriptor = Mockito.spy(hubDescriptor);
