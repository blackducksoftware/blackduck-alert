...
public class BlackDuckProviderTest {
    ...
    public void testInitializeNotConfigured() {
        ...
        final BlackDuckProvider provider = new BlackDuckProvider(accumulatorTask, projectSyncTask, null, null, taskManager, blackDuckProperties, null);
        provider.initialize();
    ...
    public void testGetNotificationTypes() {
        ...
        final BlackDuckProvider provider = new BlackDuckProvider(accumulatorTask, projectSyncTask, blackDuckContent, null, taskManager, blackDuckProperties, null);
    ...
    public void testCreateTopicCollectors() {
        ...
        final BlackDuckProvider provider = new BlackDuckProvider(accumulatorTask, projectSyncTask, null, null, taskManager, blackDuckProperties, topicCollectorFactory);
