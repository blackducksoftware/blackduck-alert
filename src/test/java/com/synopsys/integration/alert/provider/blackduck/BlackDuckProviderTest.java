...
public class BlackDuckProviderTest {
    ...
    public void testInitializeNotConfigured() {
        ...
        final BlackDuckProvider provider = new BlackDuckProvider(BLACK_DUCK_PROVIDER_KEY, accumulatorTask, projectSyncTask, null, taskManager, blackDuckProperties, null, null, null);
        provider.initialize();
    ...
    public void testGetNotificationTypes() {
        ...
        final BlackDuckProvider provider = new BlackDuckProvider(BLACK_DUCK_PROVIDER_KEY, accumulatorTask, projectSyncTask, blackDuckContent, taskManager, blackDuckProperties, null, null, null);
    ...
    public void testCreateTopicCollectors() {
        ...
        final BlackDuckProvider provider = new BlackDuckProvider(BLACK_DUCK_PROVIDER_KEY, accumulatorTask, projectSyncTask, null, taskManager, blackDuckProperties, null, null, topicCollectorFactory);
