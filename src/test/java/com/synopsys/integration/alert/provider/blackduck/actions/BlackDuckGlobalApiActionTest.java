...
public class BlackDuckGlobalApiActionTest {
    ...
    public void afterSaveActionSuccessTest() throws AlertException {
        ...
        BlackDuckGlobalApiAction blackDuckGlobalApiAction = new BlackDuckGlobalApiAction(propertiesFactory, blackDuckProvider, taskManager, providerDataAccessor, fieldModelConverter);
