...
public class ConfigurationManagerLegacy {
    ...
    public ConfigurationManagerLegacy(Gson gson, AlertRequestUtility alertRequestUtility, String blackDuckProviderKey, String channelKey) {
        this.gson = gson;
    ...
    public void createGlobalConfiguration(FieldModel globalConfig) {
        ...
        try {
            ...
            alertRequestUtility
                .executePostRequest("/api/configuration/validate", configurationRequestBody, String.format("Validating the global configuration %s failed.", descriptorName));
            alertRequestUtility
                .executePostRequest("/api/configuration/test", configurationRequestBody, String.format("Testing the global configuration %s failed.", descriptorName));
