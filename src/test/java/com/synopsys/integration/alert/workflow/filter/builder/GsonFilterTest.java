...
public class GsonFilterTest {
    ...
    public void testSingleFilter() {
        ...
        final JsonFieldFilterBuilder projectNameFilter = new JsonFieldFilterBuilder(jsonExtractor, JsonField.createStringField(JsonPath.compile("$.content.projectName"), "projectName", null, null), PROJECT_NAME_1);
    ...
    public void testOrFilter() {
        ...
        final JsonFieldFilterBuilder policyProjectNameFilter = new JsonFieldFilterBuilder(jsonExtractor, JsonField.createStringField(JsonPath.compile("$.content.projectName"), "projectName", null, null), PROJECT_NAME_1);
        final JsonFieldFilterBuilder vulnerabilityProjectNameFilter = new JsonFieldFilterBuilder(jsonExtractor, JsonField.createStringField(JsonPath.compile("$.content.affectedProjectVersions[*].projectName"), "projectName", null, null),
            PROJECT_NAME_1);
    ...
    public void testAndFilter() {
        ...
        final JsonFieldFilterBuilder vulnerabilityComponentNameFilter = new JsonFieldFilterBuilder(jsonExtractor, JsonField.createStringField(JsonPath.compile("$.content.componentName"), "componentName", null, null), COMPONENT_NAME_1);
        final JsonFieldFilterBuilder vulnerabilityProjectNameFilter = new JsonFieldFilterBuilder(jsonExtractor, JsonField.createStringField(JsonPath.compile("$.content.affectedProjectVersions[*].projectName"), "projectName", null, null),
            PROJECT_NAME_1);
