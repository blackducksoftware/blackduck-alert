...
public class AlertStartupInitializerTest {
    ...
    public void testInitializeConfigs() throws Exception {
        ...
        final ChannelDescriptor channelDescriptor = new EmailDescriptor(EMAIL_CHANNEL_KEY, new EmailGlobalUIConfig(encryptionConfigurationValidator), null);
    ...
    public void testInitializeConfigsEmptyInitializerList() throws Exception {
        ...
        Mockito.verify(baseConfigurationAccessor, Mockito.times(1)).getConfigurationByDescriptorNameAndContext(Mockito.anyString(), Mockito.any(ConfigContextEnum.class));
