...
public class GsonFilterTest {
    ...
    public void testSingleFilter() {
        final NotificationContent policyNotification = createPolicyContent("TestProject", "1.0.0");
        ...
        final JsonFieldFilter projectNameFilter = new JsonFieldFilter(gson, jsonFieldList, "TestProject");
    ...
    public void testOrFilter() {
        final NotificationContent policyNotification = createPolicyContent("TestProject", "1.0.0");
        final NotificationContent vulnerabilityNotification = createVulnerabilityContent("TestProject", "1.0.0");

        final List<NotificationContent> notificationList = Arrays.asList(policyNotification, vulnerabilityNotification);
        final List<String> policyJsonFieldHierarchy = Arrays.asList("content", "projectName");
        final JsonFieldFilter policyProjectNameFilter = new JsonFieldFilter(gson, policyJsonFieldHierarchy, "TestProject");
        final List<String> vulnerabilityJsonFieldHierarchy = Arrays.asList("content", "affectedProjectVersions", "projectName");
        final JsonFieldFilter vulnerabilityProjectNameFilter = new JsonFieldFilter(gson, vulnerabilityJsonFieldHierarchy, "TestProject");
