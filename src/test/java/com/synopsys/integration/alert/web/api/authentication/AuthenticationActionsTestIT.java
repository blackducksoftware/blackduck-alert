...
public class AuthenticationActionsTestIT extends AlertIntegrationTest {
    ...
    public void testAuthenticationLDAPExceptionIT() throws Exception {
        ...
        AuthorizationAccessor authorizationAccessor = Mockito.mock(AuthorizationAccessor.class);

        AlertDatabaseAuthenticationPerformer alertDatabaseAuthenticationPerformer = new AlertDatabaseAuthenticationPerformer(authenticationEventManager, authorizationAccessor, databaseProvider);
        LdapAuthenticationPerformer ldapAuthenticationPerformer = new LdapAuthenticationPerformer(authenticationEventManager, authorizationAccessor, mockLdapManager);
