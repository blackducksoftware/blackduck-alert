...
public class ProviderDataAccessorTestIT extends AlertIntegrationTest {
    ...
    public void deleteAndSaveAllProjectsTest() {
        ...
        List<ProviderProject> savedProjects = providerDataAccessor.saveProjects(providerName, newProjects);
    ...
    public void deleteAndSaveAllUsersTest() {
        ...
        List<ProviderUserModel> savedUsers = providerDataAccessor.saveUsers(providerName, newUsers);
