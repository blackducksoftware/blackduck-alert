...
@Component
public class ProxySettingsEnvironmentHandlerFactory2 implements EnvironmentVariableHandlerFactory2<SettingsProxyModel> {
    ...
    @Autowired
    public ProxySettingsEnvironmentHandlerFactory2(SettingsProxyConfigAccessor configAccessor, EnvironmentVariableUtility environmentVariableUtility, SettingsProxyValidator validator) {
    ...
    @Override
    public EnvironmentVariableHandler2<SettingsProxyModel> build() {
        return EnvironmentVariableHandler2.create(
            HANDLER_NAME,
            PROXY_CONFIGURATION_KEYSET,
    ...
    private SettingsProxyModel configureModel() {
    ...
    private ValidationResponseModel validateConfiguration(SettingsProxyModel configModel) {
        return validator.validate(configModel);
    }

    private EnvironmentProcessingResult updateConfiguration(SettingsProxyModel configModel) {
