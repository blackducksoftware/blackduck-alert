...
public class JiraServerCommentGenerator implements IssueTrackerCommentEventGenerator<String> {
    ...
    public JiraServerCommentGenerator(JiraServerChannelKey channelKey, UUID jobId) {
    ...
    public IssueTrackerCommentEvent<String> generateEvent(IssueCommentModel<String> model) {
        return new JiraServerCommentEvent(IssueTrackerCommentEvent.createDefaultEventDestination(channelKey), jobId, model);
    }
}
