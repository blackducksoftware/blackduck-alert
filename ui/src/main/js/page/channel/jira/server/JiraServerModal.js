        ...
        >
            ...
            <div>
                ...
                <TextInput
                    ...
                    label="Name"
                    tooltipDescription="The unique name for the Jira server."
                    required
                    readOnly={readonly}
                ...
                <TextInput
                    ...
                    label="URL"
                    tooltipDescription="The URL of the Jira server."
                    required
                    readOnly={readonly}
                    onChange={FieldModelUtilities.handleTestChange(jiraServerModel, setJiraServerModel)}
                ...
                <RadioInput
                    ...
                    tooltipDescription="Select the type of authentication that you would like to use for connecting to the intended Jira Server."
                    readOnly={readonly}
                    onChange={FieldModelUtilities.handleTestChange(jiraServerModel, setJiraServerModel)}
                ...
                {jiraServerModel.authorizationMethod === 'BASIC' ? (
                    <>
                        <TextInput
                            ...
                            label="User Name"
                            tooltipDescription="The username of the Jira Server user. Note: Unless 'Disable Plugin Check' is checked, this user must be a Jira admin."
                            required
                            readOnly={readonly}
                            onChange={FieldModelUtilities.handleTestChange(jiraServerModel, setJiraServerModel)}
                        ...
                        <PasswordInput
                            ...
                            label="Password"
                            tooltipDescription="The password of the specified Jira Server user."
                            required
                            readOnly={readonly}
                            onChange={FieldModelUtilities.handleTestChange(jiraServerModel, setJiraServerModel)}
                    ...
                    <PasswordInput
                        ...
                        label="Access Token"
                        tooltipDescription="The Jira Server's access token used for authentication."
                        required
                        readOnly={readonly}
                        onChange={FieldModelUtilities.handleTestChange(jiraServerModel, setJiraServerModel)}
                ...
                <NumberInput
                    ...
                    label="Timeout"
                    tooltipDescription="The timeout in seconds for connections to the Jira server instance."
                    required
                    readOnly={readonly}
                    onChange={FieldModelUtilities.handleTestChange(jiraServerModel, setJiraServerModel)}
                ...
                <CheckboxInput
                    ...
                    tooltipDescription="This will disable checking whether the 'Alert Issue Property Indexer' plugin is installed on the specified Jira instance. Please ensure that the plugin is manually installed before using Alert with Jira. If not, issues created by Alert will not be updated properly, and duplicate issues may be created."
                    readOnly={readonly}
                ...
                <ButtonField
                    ...
                    tooltipDescription="Installs a required plugin on the Jira server."
