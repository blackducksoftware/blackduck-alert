...
const AzureBoardsTable = ({ readonly, allowDelete }) => {
    ...
    function handlePageSize(count) {
        // If page size increases, the page number we show may decrease so recalculate page to the first element of current page
        const currentPageLastElement = (data?.currentPage * data?.pageSize) + 1;
