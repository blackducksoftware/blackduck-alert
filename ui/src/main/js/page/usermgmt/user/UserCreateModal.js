...
const UserCreateModal = ({ data, isOpen, toggleModal }) => {
    ...
    function passwordsMatch(user) {
        ...
        setNewUser(Object.assign(user, { [UserFieldKeyEnum.CONFIRM_PASSWORD_ERROR_KEY]: passwordError }));
        ...
        >
            <div>
                <TextInput
                    ...
                    value={newUser[UserFieldKeyEnum.USERNAME_KEY]}
                ...
                <PasswordInput
                    ...
                    value={newUser[UserFieldKeyEnum.PASSWORD_KEY]}
                    isSet={false}
                ...
                <PasswordInput
                    ...
                    value={newUser[UserFieldKeyEnum.CONFIRM_PASSWORD_KEY]}
                    errorName={UserFieldKeyEnum.CONFIRM_PASSWORD_KEY}
                    errorValue={newUser[UserFieldKeyEnum.CONFIRM_PASSWORD_ERROR_KEY]}
                />
                <TextInput
                    ...
                    value={newUser[UserFieldKeyEnum.EMAIL_KEY]}
                ...
                <DynamicSelectInput
                    ...
                    multiSelect
                    options={getRoles()}
                    value={newUser[UserFieldKeyEnum.ROLENAMES_KEY]}
