        ...
        >
            <div className={classes.userModalContent}>
                ...
                <TextInput
                    ...
                    label="Username"
                    tooltipDescription="The user's username."
                ...
                <PasswordInput
                    ...
                    label="Password"
                    tooltipDescription="The user's password."
                ...
                <TextInput
                    ...
                    label="Email"
                    tooltipDescription="The user's email."
                ...
                <DynamicSelectInput
                    ...
                    label="Roles"
                    tooltipDescription="Select the roles you want associated with the user."
