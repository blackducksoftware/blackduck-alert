...
const SettingsProxyConfiguration = ({
    ...
    return (
        <FormCard formTitle="Proxy Configuration">
            ...
            >
                <TextInput
                    ...
                    name="proxyHost"
                    label="Proxy Host"
                    fieldDescription="The host name of the proxy server to use."
                    readOnly={readOnly}
                ...
                <NumberInput
                    ...
                    name="proxyPort"
                    label="Proxy Port"
                    fieldDescription="The port of the proxy server to use."
                    readOnly={readOnly}
                    onChange={fieldModelUtilities.handleTestChange(settingsProxyConfig, setSettingsProxyConfig)}
                ...
                <TextInput
                    ...
                    fieldDescription="If the proxy server requires authentication, the username to authenticate with the proxy server."
                    readOnly={readOnly}
                    onChange={fieldModelUtilities.handleTestChange(settingsProxyConfig, setSettingsProxyConfig)}
                ...
                <PasswordInput
                    ...
                    fieldDescription="If the proxy server requires authentication, the password to authenticate with the proxy server."
                    readOnly={readOnly}
                    onChange={fieldModelUtilities.handleTestChange(settingsProxyConfig, setSettingsProxyConfig)}
                ...
                <DynamicSelectInput
                    ...
                    fieldDescription="Hosts whose network traffic should not go through the proxy."
                    readOnly={readOnly}
                    onChange={fieldModelUtilities.handleTestChange(settingsProxyConfig, setSettingsProxyConfig)}
