...
// Github - SCM
export const GET_GITHUB_FETCHING = 'GET_GITHUB_FETCHING';
export const GET_GITHUB_SUCCESS = 'GET_GITHUB_SUCCESS';
export const GET_GITHUB_ERROR = 'GET_GITHUB_ERROR';
export const ADD_GITHUB_USER_REQUEST = 'ADD_GITHUB_USER_REQUEST';
export const ADD_GITHUB_USER_SUCCESS = 'ADD_GITHUB_USER_SUCCESS';
export const ADD_GITHUB_USER_FAIL = 'ADD_GITHUB_USER_FAIL';
export const VALIDATE_GITHUB_CONFIGURATION_REQUEST = 'VALIDATE_GITHUB_CONFIGURATION_REQUEST';
export const VALIDATE_GITHUB_CONFIGURATION_SUCCESS = 'VALIDATE_GITHUB_CONFIGURATION_SUCCESS';
export const VALIDATE_GITHUB_CONFIGURATION_FAIL = 'VALIDATE_GITHUB_CONFIGURATION_FAIL';
export const VALIDATE_GITHUB_CONFIGURATION_ERROR = 'VALIDATE_GITHUB_CONFIGURATION_ERROR';
export const DELETE_GITHUB_CONFIG_REQUEST  = 'DELETE_GITHUB_CONFIG_REQUEST';
export const DELETE_GITHUB_CONFIG_SUCCESS = 'DELETE_GITHUB_CONFIG_SUCCESS';
export const DELETE_GITHUB_CONFIG_FAIL = 'DELETE_GITHUB_CONFIG_FAIL';
export const DELETE_GITHUB_CONFIG_ERROR = 'DELETE_GITHUB_CONFIG_ERROR';