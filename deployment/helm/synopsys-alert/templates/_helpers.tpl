...
{{- if (eq .Values.postgres.sslConfig.sslUseFiles true) -}}
...
{{- if and (eq .Values.postgres.isExternal true) (eq .Values.postgres.ssl true) -}}
{{- if (eq .Values.postgres.sslConfig.sslUseFiles true) -}}
ALERT_DB_SSL_KEY_PATH: {{ .Values.postgres.sslConfig.sslKeyFilePath }}
ALERT_DB_SSL_CERT_PATH: {{ .Values.postgres.sslConfig.sslCertFilePath }}
ALERT_DB_SSL_ROOT_CERT_PATH: {{ .Values.postgres.sslConfig.sslRootCertPath }}
{{- end -}}
{{- end -}}
{{- end -}}
