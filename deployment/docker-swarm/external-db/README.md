...
7. Create ALERT_RABBITMQ_USER secret.
8. Create ALERT_RABBITMQ_PASSWORD secret.
9. Manage certificates.
10. Modify environment variables.
11. Deploy the stack.
...
- Overrides File Changes.
    ...
    Note: 
        ...
        Black Duck recommends setting the deploy.resources using the following formula: ALERT_MAX_HEAP_SIZE + 256M.
        ```bash
