...
public class JiraCloudDistributionConfigurationValidator implements DistributionConfigurationValidator {
    ...
    @Autowired
    public JiraCloudDistributionConfigurationValidator(Gson gson, JiraCloudChannelKey jiraCloudChannelKey, JiraFieldMappingValidator jiraFieldMappingValidator,
