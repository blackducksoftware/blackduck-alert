...
public class JiraCloudProcessor implements IssueTrackerMessageProcessor<String> {
    private final IssueTrackerModelExtractor<String> modelExtractor;
    private final AsyncMessageSender<IssueTrackerModelHolder<String>> messageSender;

    public JiraCloudProcessor(IssueTrackerModelExtractor<String> modelExtractor, AsyncMessageSender<IssueTrackerModelHolder<String>> messageSender) {
