...
@Component
public class JiraCloudModelExtractor extends IssueTrackerModelExtractor<String> {
    @Autowired
    public JiraCloudModelExtractor(JiraMessageFormatter formatter, JiraCloudSearcher searcher) {
        super(formatter, searcher);
    }
