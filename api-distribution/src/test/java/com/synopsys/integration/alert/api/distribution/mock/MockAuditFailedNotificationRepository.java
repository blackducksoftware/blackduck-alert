...
public class MockAuditFailedNotificationRepository extends MockRepositoryContainer<AuditFailedNotificationRelationPK, AuditFailedNotificationRelation> implements
    ...
    @Override
    public List<AuditFailedNotificationRelation> findAuditFailedNotificationRelationsByNotificationId(Long notificationId) {
    ...
    @Override
    public List<AuditFailedNotificationRelation> findAuditFailedNotificationRelationsByFailedAuditEntryId(UUID failedAuditEntryId) {
