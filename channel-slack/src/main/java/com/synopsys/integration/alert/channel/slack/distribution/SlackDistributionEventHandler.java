...
public class SlackDistributionEventHandler extends DistributionEventHandler<SlackJobDetailsModel> {
    @Autowired
    public SlackDistributionEventHandler(SlackChannel channel, SlackJobDetailsAccessor jobDetailsAccessor, ProcessingAuditAccessor auditAccessor, JobAccessor jobAccessor) {
