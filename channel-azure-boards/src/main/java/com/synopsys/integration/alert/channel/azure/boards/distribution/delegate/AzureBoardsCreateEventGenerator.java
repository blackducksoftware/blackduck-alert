...
public class AzureBoardsCreateEventGenerator implements IssueTrackerCreationEventGenerator {
    ...
    public AzureBoardsCreateEventGenerator(AzureBoardsChannelKey channelKey, UUID jobId) {
    ...
    public IssueTrackerCreateIssueEvent generateEvent(IssueCreationModel model) {
        return new AzureBoardsCreateIssueEvent(IssueTrackerCreateIssueEvent.createDefaultEventDestination(channelKey), jobId, model);
    }
}
